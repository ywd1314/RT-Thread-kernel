...
rt_err_t rt_timer_start(rt_timer_t timer)
{
	...
	/* 获取timeout tick,
	   最大的timeout tick不能大于RT_TICK_MAX/2 */
...
/**
 *该函数用于扫描系统定时器列表，当有超时事件发生时，调用对应的超时函数
 *
