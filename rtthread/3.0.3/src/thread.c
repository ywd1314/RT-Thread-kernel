 ...
 *
 *@note 如果挂起的是线程自身，在调用该函数后，必须调用rt_schedule()进行系统调度
 *
 */
...
/**
 *该函数将让当前线程休眠一段时间，单位为tick
 *
 *@param tick 休眠时间，单位为tick
 *
 *@return RT_EOK
 */
...
/**
 *
 *该函数将使当前线程让出处理器，调度器选择最高优先级的线程执行
 *
 *当前线程还是处于就绪态
 *
 *@return RT_EOK
